  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-primary/10 p-6 flex flex-wrap gap-4 items-end">
      ...
      <div class="min-w-[160px]">
        ...
        <input v-model="filters.budget_max" @input="debouncedSearch" type="number" min="0" placeholder="Ex: 10000"
          class="w-full border border-gray-200 rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-primary" />
      </div>
    ...
    <!-- Aucun résultat -->
    <div v-if="!loading && missions.length === 0" class="text-center py-20 bg-white rounded-[2rem] border border-primary/5">
