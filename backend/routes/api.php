...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/contracts/{id}/messages', [MessageController::class, 'getConversation']);

    // ── Contracts ────────────────────────────────────────────────────────────
    Route::post('/contracts',              [ContractController::class, 'store']);
    Route::post('/contracts/{id}/complete',[ContractController::class, 'complete']);
    Route::post('/contracts/{id}/refund',  [ContractController::class, 'refund']);
    Route::get('/contracts/client',        [ContractController::class, 'clientContracts']);
    Route::get('/contracts/freelancer',    [ContractController::class, 'freelancerContracts']);
});
